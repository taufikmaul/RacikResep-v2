...
INSERT INTO "new_ingredients" ("businessId", "categoryId", "conversionFactor", "costPerUnit", "createdAt", "description", "id", "name", "packageSize", "purchasePrice", "purchaseUnitId", "sku", "updatedAt", "usageUnitId") SELECT "businessId", "categoryId", "conversionFactor", "costPerUnit", "createdAt", "description", "id", "name", "packageSize", "purchasePrice", "purchaseUnitId", "sku", "updatedAt", "usageUnitId" FROM "ingredients";
